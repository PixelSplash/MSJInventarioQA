...
//            conn.close();
    ...
    //preguntar a sergio como carga los diferentes html si es admin o no
    ...
    public ArrayList<Objeto> listaObjetosPublicados(boolean isAdmin) {
        ArrayList<Objeto> listaObjetos = new ArrayList<>();
        ...
        try{
            ...
            if(isAdmin){
                ...
                resultado = stmt.executeQuery("SELECT * FROM Objeto WHERE fechaCatalogo <= '"+dtf.format(localDate)+"';");            
            }
            System.out.println();
...
//            conn.close();
    ...
    public ArrayList<Objeto> busquedaObjetos(Busqueda busqueda, boolean isAdmin) {
        ...
        try{
            ...
            if(isAdmin){
                if(busqueda.equals("")) resultado = stmt.executeQuery("SELECT * FROM Objeto;");
                else resultado = stmt.executeQuery("SELECT * FROM Objeto WHERE " + busqueda.getAb().toString() + " LIKE \"%" + busqueda.getInput() + "%\" ;");

            }else{
                if(busqueda.equals("")) resultado = stmt.executeQuery("SELECT * FROM Objeto WHERE fechaCatalogo <= '"+dtf.format(localDate)+"';");
                resultado = stmt.executeQuery("SELECT * FROM Objeto WHERE fechaCatalogo <= '"+dtf.format(localDate)+"' AND " + busqueda.getAb().toString() + " LIKE \"%" + busqueda.getInput() + "%\" ;");            
            }
